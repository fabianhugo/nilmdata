...
#df6=readfeatures('/home/burr/nilmcode/data/2008_1200', appliancelist)
...
#model1 = RandomForestClassifier(n_estimators =10,min_samples_leaf=1, max_leaf_nodes=50,random_state=10)
...
evaluate(y_test, y_pred, labellist, plotconfusionmatrix="3OnModel1")
...
evaluate(y_testu, y_predu, labellist, plotconfusionmatrix="3OnModel3")
